...
const DeletedList = ({ deleted, formatDate }) => (
  <div className="mt-10">
    ...
    <ul className="space-y-2">
      {deleted.map(task => (
        <li key={task.id} className="flex flex-col md:flex-row md:items-center justify-between bg-deleted/10 rounded-lg p-3 text-deleted border border-rose-200 shadow-md">
          <div>
